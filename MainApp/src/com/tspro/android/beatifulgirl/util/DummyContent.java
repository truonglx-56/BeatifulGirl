...
import com.tspro.android.beatifulgirl.model.DummyModel;
import com.tspro.android.beatifulgirl.model.ImageGalleryCategoryModel;
import com.tspro.android.beatifulgirl.model.ImageGallerySubcategoryModel;
...
public class DummyContent {
	...
	public static ArrayList<DummyModel> getDummyModelList() {
		...
		list.add(new DummyModel(15,"https://scontent.xx.fbcdn.net/v/t1.0-9/s720x720/19030634_890866854385739_7548557346216240425_n.jpg?_nc_ad=z-m&_nc_cid=0&oh=9f313cb775c0a439d7b79c6f327d7054&oe=5A3DD1A6", "Hannah Martin", R.string.fontello_heart_empty));
		for(int i =16;i<1000;i++){
			list.add(new DummyModel(i, "https://scontent.xx.fbcdn.net/v/t1.0-9/s720x720/19030634_890866854385739_7548557346216240425_n.jpg?_nc_ad=z-m&_nc_cid=0&oh=9f313cb775c0a439d7b79c6f327d7054&oe=5A3DD1A6", "Hannah Martin", R.string.fontello_heart_empty));
	...
	public static ArrayList<DummyModel> getSocialDummyList() {
		ArrayList<DummyModel> list = new ArrayList<>();
		list.add(new DummyModel(0, "https://scontent.xx.fbcdn.net/v/t1.0-9/s720x720/22046413_1841442712834850_8080464456425968823_n.jpg?_nc_ad=z-m&_nc_cid=0&oh=38418a422bced5fcddbe608257592ea8&oe=5A4B3ECE", "Trang chủ", R.string.material_icon_account));
		list.add(new DummyModel(1, "https://scontent.xx.fbcdn.net/v/t1.0-0/p480x480/22089237_150883495511495_4754853763290884551_n.jpg?_nc_ad=z-m&_nc_cid=0&oh=38b8b2b2a3cbbd29a43a598501af17a7&oe=5A86E6DE", "Yêu thích", R.string.material_icon_like));
		list.add(new DummyModel(2, "https://scontent.xx.fbcdn.net/v/t1.0-9/s720x720/22089011_991834640963605_3546033772155093214_n.jpg?_nc_ad=z-m&_nc_cid=0&oh=ccc9d04e6e26e416ba30586c78189499&oe=5A83F2B0", "Thư viện", R.string.material_icon_bookmark));
		list.add(new DummyModel(3, "https://scontent.xx.fbcdn.net/v/t1.0-9/s720x720/22050167_1286969271448930_7650859139965831578_n.jpg?_nc_ad=z-m&_nc_cid=0&oh=6b9eb45ba8660105b269150125eb7be1&oe=5A42B4EF", "Thông tin", R.string.material_icon_settings));
		list.add(new DummyModel(4, "https://scontent.xx.fbcdn.net/v/t1.0-9/p720x720/22046540_388623124888448_1049148413994646900_n.jpg?_nc_ad=z-m&_nc_cid=0&oh=61880d2debdd0c16a01a5c0ca608a004&oe=5A480A5B", "Yêu thích", R.string.material_icon_account));
		return list;
	}
