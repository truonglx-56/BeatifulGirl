...
import com.tspro.android.beatifulgirl.adapter.GoogleCardsSocialAdapter;
...
public class HomePageFragment extends Fragment implements OnDismissCallback {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mGoogleCardsAdapter = new GoogleCardsSocialAdapter(reference);
    ...
    private void setData(final String link, final boolean isPullToRefresh) {
        if (!TextUtils.isEmpty(link)) {
                                ...
                                synchronized (lock) {
                                    ...
                                    for (int i = 0; i < size; i++) {
                                        ...
                                        if (item != null) {
                                            ...
                                            MainApplication.getInstance().addEntry(item);
                                        }
                                    }
            ...
            MainApplication.getInstance().addToRequestQueue(jsonObjReq, MainApplication.JSON_ARRAY_QUEUE_LIST);
        }
    }
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            synchronized (lock) {
                List<Entry> list = new ArrayList<>(MainApplication.getInstance().getMapEntry().values());
